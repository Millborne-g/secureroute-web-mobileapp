  ...
  useEffect(() => {
    ...
    const initialCrimeSetup = () => {
      ...
      if (selectedRouting === "Time-based") {
        ...
        calculatedCrime = sortedCrimes[0];
      } else {
        const sortedCrimes = crimes.sort(
          (a, b) => distance(location, a) - distance(location, b)[0]
        );
        calculatedCrime = sortedCrimes[0];
      }
      // prevent initiliizng
    ...
    initialCrimeSetup();
  }, [selectedRouting, location, crimes, flag]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.crimeNav}>
        <TouchableOpacity style={[styles.crimeNavPressable, styles.prev]}>
          <Text style={styles.crimeNavTxt}>PREV</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.crimeNavPressable, styles.next]}>
